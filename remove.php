...
<body>
    <div class="w3-container w3-padding w3-xlarge w3-padding-16">Remove a product</div>
            ...
            while($row=mysqli_fetch_array($product_query)){
                ...
                echo"
                    <tr>
                        ...
                        <td>$pexpire</td>
                        <td>$pmanu</td>
                        <td><a href='remove.php?delete=$bid'><button class='w3-button w3-red'>Delete this Item</button></a></td>
                    </tr>
